    ...
    class DatePicker extends HTMLElement {
      ...
      connectedCallback() {
        ...
        const [prevBtn, calendarDateElement, nextButton] = this.calendarDropDown
          .querySelector('.header-control').children;
      ...
      render() {
        ...
        this.shadow.innerHTML = `
          ...
          <div class="calendar-dropdown ${this.visible ? 'visible' : ''} ${this.position}">
            <div class="header">
                  <span class="header-title">Lịch hẹn</span>
            ...
            <div class="status">
                  <div class="status__detail">
                        <div>
                              <span class="dot" style="background-color: #7FC128;"></span> Đã xác nhận
                        </div>
                        <div>
                              <span class="dot" style="background-color: #0FAFF6;"></span>Chưa xác nhận
                        </div>
                        <div>
                              <span class="dot" style="background-color: #7161BA;"></span>Hoàn thành
                        </div>
                        <div>
                              <span class="dot" style="background-color: #EE6955;"></span>Hủy
                        </div>
                  </div>      
            </div>
            <div class="week-days">
                  <div class="month-day__item">CN</div>
                  <div class="month-day__item">T2</div>
                  <div class="month-day__item">T3</div>
                  <div class="month-day__item">T4</div>
                  <div class="month-day__item">T5</div>
                  <div class="month-day__item">T6</div>
                  <div class="month-day__item">T7</div>
            </div>
