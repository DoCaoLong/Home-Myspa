...
<div class="main-momo">
    <div class="popup-combo item active  momo-register">
        <img class="branch-img-pop-up"
            src="<?php echo base_url(); ?>assets/frontend/images/popup/form-popup-free-marketing-1.jpg" />
        <img class="pop-up-mobile"
            src="<?php echo base_url(); ?>assets/frontend/images/popup/mobile-form-popup-free-marketing-1.jpg" />
        <div class="form-branch-app">
            <div class="title">
                <p> Đăng ký bán hàng trên BeautyX
                </p>
            </div>
            <form action="">
                ...
                <div class="input">
                    <img class="icon" src="<?php echo base_url(); ?>assets/frontend/images/icon/Icon/user.svg"
                        alt="icon">
                    <input type="text" name="name" id="pop_up_name" placeholder="Họ và tên *" />
                    <span class="errors_log">missing</span>
                </div>
                <div class="input">
                    <img class="icon" src="<?php echo base_url(); ?>assets/frontend/images/icon/Icon/building.svg"
                        alt="icon">
                    <input type="text" name="business_name" id="pop_up_business_name" placeholder="Doanh nghiệp *" />
                    <span class="errors_log">missing</span>
                </div>
                <div class="input">
                    <img class="icon" src="<?php echo base_url(); ?>assets/frontend/images/icon/Icon/map-pin.svg"
                        alt="icon">
                    <input type="text" name="business_add" id="pop_up_business_add" placeholder="Địa chỉ" />
                </div>
                <div class="input">
                    <img class="icon" src="<?php echo base_url(); ?>assets/frontend/images/icon/Icon/phone.svg"
                        alt="icon">
                    <input type="phone" name="phone" id="pop_up_phone" placeholder="Số điện thoại *" />
                    <span class="errors_log">missing</span>
                </div>
                <div class="input">
                    <img class="icon" src="<?php echo base_url(); ?>assets/frontend/images/icon/Icon/mail.svg"
                        alt="icon">
