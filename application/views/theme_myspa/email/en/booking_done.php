    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="margin: auto;" class="email-container">
        ...
        <tr>
            <td bgcolor="#7266BA" style="padding: 15px;">
                ...
                <h3 style="color:#FFF; text-align: center; margin:5px;">THANK YOU!</h3>
            </td>
        </tr>
        ...
        <tr>
            <td bgcolor="#ffffff" style="padding: 0px 15px 20px; text-align: justify; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                ...
                Thanks for booking with us, your reservation code: <span style="font-size: 30; font-weight: 900; color:#f26c4f"><?php echo (isset($booking_code) ? $booking_code : '') ;?></span>
                <br>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td dir="ltr" valign="top" style="padding: 5px;">
                                        ...
                                        <a href="https://www.google.com/maps/place/<?php echo isset($company_info['address']) ? urlencode($company_info['address']) : ''; ?>" style="font-size: 12px; text-decoration: none;" target="_blank">View map</a><br>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <?php if (strtotime(date('Y-m-d H:i:s')) < strtotime(format_date_time_for_db($start))) { ?>
                    <h3>Cancel booking online</h3>
                    Please click the link <a href="<?php echo base_url();?>Booking/cancel_appointment?booking_code=<?php echo $booking_code?>&lang=en">&nbsp;Cancel booking online</a> if you want.
                <?php }?>
                <br>
