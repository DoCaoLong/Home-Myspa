...
<center style="width: 100%; background: #FFF;">
    ...
    <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
        Khách hàng: <?php echo (isset($booking_name) ? $booking_name : '') ;?> vừa hủy đặt hẹn với mã đặt hẹn: <?php echo (isset($booking_code) ? $booking_code : '') ;?>
    </div>
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="margin: auto;" class="email-container">
        ...
        <tr>
            <td bgcolor="#7266BA" style="padding: 15px;">
                ...
                <h3 style="color:#FFF; text-align: center; margin:5px;">KHÁCH HÀNG VỪA HỦY ĐẶT HẸN!</h3>
            </td>
        </tr>
        ...
        <tr>
            <td bgcolor="#ffffff" style="padding: 0px 15px 20px; text-align: justify; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                ...
                Khách hàng: <?php echo (isset($booking_name) ? $booking_name : '') ;?> vừa hủy đặt hẹn với mã đặt hẹn: <span style="font-size: 30; font-weight: 900; color:#f26c4f"><?php echo (isset($booking_code) ? $booking_code : '') ;?></span>
                <br>
